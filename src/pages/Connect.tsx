    ...
    <div className="max-w-2xl mx-auto pb-12 md:pb-20 pt-4 md:pt-8 text-center">
      ...
      <div className="mb-12">
        ...
        <div className="text-xl text-gray-600 font-serif leading-relaxed space-y-4">
          ...
          <p>
            Whether you have a question or just want to say hi, I'm happy to get back to you!
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-50 p-8 md:p-12 rounded-3xl">
        ...
        <form target="_blank" action="https://formsubmit.co/sooyeanjang@gmail.com" method="POST" className="space-y-6 text-left">
          ...
          <div>
            <label htmlFor="email" className="block text-sm font-bold uppercase tracking-wider text-gray-500 mb-2">Email</label>
            <input 
              type="email" 
              id="email"
              name="email"
