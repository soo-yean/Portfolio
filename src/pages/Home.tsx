...
const Home = () => {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center text-center">
      <div className="w-64 h-64 md:w-96 md:h-96 mb-12">
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <p className="text-xl md:text-2xl text-gray-600 font-serif leading-relaxed">
          I'm a software developer who loves to tell stories through code.
          Currently building digital experiences that make people smile.
        </p>
